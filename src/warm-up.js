...
/*var isFavorite = true;
 if (title === 'Harpo Speaks') {
   console.log(`${title} is my favorite book`);
 }*/
var isFavorite = title === 'Harpo Speaks';
...
// comparison operator.
      //var isShortStory = true;
        //if (pages < 25){
        //  console.log('It is a short story.')
        //}
      //  else {console.log('I wouldn\'t consider that to be a short story')};
...
var books = ['Beloved','The Fifth Season','The Sellout','Black Leopard, Red Wolf','Americanah',];
...
var belowTwoHundred = [22, 44, 66, 88, 11, 33, 55, 77, 99, 111, 199, 121];
